...
/***/ function(module, exports, __webpack_require__) {
	...
	var _searchJsx = __webpack_require__(157);

	var _searchJsx2 = _interopRequireDefault(_searchJsx);

	var _addFormJsx = __webpack_require__(158);

	var _addFormJsx2 = _interopRequireDefault(_addFormJsx);

	var _emojilistJsx = __webpack_require__(159);
	...
	var Content = _react2["default"].createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2["default"].createElement(
	      ...
	      _react2["default"].createElement(_searchJsx2["default"], { changeFilter: this.changeFilter }),
	      _react2["default"].createElement(_emojilistJsx2["default"], { data: data }),
	      _react2["default"].createElement(_addFormJsx2["default"], { changeEmojis: this.changeEmojis })
	    );
	  }
	});

	_react2["default"].render(_react2["default"].createElement(Content, null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchInput = _react2["default"].createClass({
	  ...
	  render: function render() {
	    return _react2["default"].createElement("input", { placeholder: "search by tag" });
	  }
	});

	var SearchButton = _react2["default"].createClass({
	...
	exports["default"] = _react2["default"].createClass({
	  ...
	  render: function render() {
	    return _react2["default"].createElement(
	      ...
	      _react2["default"].createElement(SearchButton, { changeFilter: this.props.changeFilter })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddInput = _react2["default"].createClass({
	  ...
	  render: function render() {
	    return _react2["default"].createElement(
	      "div",
	      null,
	      _react2["default"].createElement("input", { placeholder: "add an emoji" }),
	      _react2["default"].createElement("br", null),
	      _react2["default"].createElement("input", { placeholder: "tags (sep. by comma)" })
	    );
	  }
	});
	...
	exports["default"] = _react2["default"].createClass({
	  ...
	  render: function render() {
	    return _react2["default"].createElement(
	      "div",
	      null,
	      _react2["default"].createElement(AddInput, null),
	      _react2["default"].createElement(AddButton, { changeEmojis: this.props.changeEmojis })
	    );
	  }
	});
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emoji = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      'li',
	      { className: 'emoji', key: this.props.key, onClick: this.select },
	      _react2['default'].createElement('input', { key: this.props.key, onClick: this.select, value: this.props.data.emoji, readOnly: true }),
	      _react2['default'].createElement(
	        'div',
	      ...
	      _react2['default'].createElement(
	        'button',
	        { onClick: this.confirmDelete, className: 'deleteButton hidden' },
	        'Delete?'
	      ),
	      _react2['default'].createElement(
	        'div',
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    var emojis = this.props.data.emojis.map(function (emoji) {
	      ...
	      return _react2['default'].createElement(Emoji, { data: data });
	    });
